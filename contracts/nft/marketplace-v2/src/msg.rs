use crate::state::{Ask, Bid, CollectionBid, Config, TokenId};
...
pub enum ExecuteMsg {
    ...
    SetBid { token_id: TokenId, price: Coin },
    ...
    SetCollectionBid { units: u32, price: Coin },
    /// Remove a bid (limit order) across an entire collection
    RemoveCollectionBid {},
    /// Accept a collection bid
    AcceptCollectionBid { token_id: TokenId, bidder: String },
}
...
pub enum QueryMsg {
    ...
    Bid { token_id: TokenId, bidder: String },
