...
use pg721_updatable::msg::{
    CollectionInfoResponse, FrozenTokenMetadataResponse, InstantiateMsg, QueryMsg,
};
...
fn main() {
    ...
    export_schema(&schema_for!(FrozenTokenMetadataResponse), &out_dir);
