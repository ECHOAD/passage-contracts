...
pub enum ContractError {
    ...
    #[error("Collection is not currently affiliated with an ecosystem: {address}")]
    CollectionNotAffiliated { address: String },
    #[error("Collection is already affiliated with ecosystem: {ecosystem_id}")]
    CollectionAlreadyAffiliated { ecosystem_id: String },
    ...
    NotEcosystemFactory {},
    #[error("Collection registration must go through configured collection-factory for ecosystem: {ecosystem_id}")]
